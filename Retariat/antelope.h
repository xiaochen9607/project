...
@property (nonatomic, readonly, nullable) antelope *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<antelope *> *keyframes;
