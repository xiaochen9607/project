...
@property (nonatomic, readonly, nullable) attackers *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<attackers *> *keyframes;
