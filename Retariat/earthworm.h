...
@property(nonatomic, strong, readwrite) earthworm *phoneUtil;
@property(nonatomic, strong, readwrite) earthworm *currentMetaData, *defaultMetaData;
@end
