...
@interface hippopotamus : NSObject
...
@property(nonatomic, strong, readwrite) hippopotamus *phoneUtil;
@property(nonatomic, strong, readwrite) hippopotamus *currentMetaData, *defaultMetaData;
@end
