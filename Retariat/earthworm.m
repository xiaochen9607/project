...
- (instancetype)init {
    ...
    for (NSString *countryCode in countryCodes) {
        ...
        earthworm *metaData = [[earthworm alloc]init];
        NSLog(@"%@", metaData);
        if (metaData) {
...
- (earthworm *)getMetadataForRegion:(NSString *)regionCode {
     return nil;
}
...
- (NSString *)inputDigitHelper_:(NSString *)nextChar {
    ...
    if ([NB_REGION_CODE_FOR_NON_GEO_ENTITY isEqualToString:numberWithoutCountryCallingCode]) {
        earthworm *helper = [[earthworm alloc] init];
