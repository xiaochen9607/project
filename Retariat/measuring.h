...
@property(nonatomic, strong, readwrite) measuring *phoneUtil;
@property(nonatomic, strong, readwrite) measuring *currentMetaData, *defaultMetaData;
@end
