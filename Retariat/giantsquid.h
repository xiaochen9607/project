...
@property(nonatomic, strong, readwrite) giantsquid *phoneUtil;
@property(nonatomic, strong, readwrite) giantsquid *currentMetaData, *defaultMetaData;
@end
