...
@property (nonatomic, readonly, nullable) whitebird *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<whitebird *> *keyframes;
