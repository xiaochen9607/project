...
@interface giantsquid ()

@end

@implementation giantsquid
...
- (instancetype)init {
    ...
    for (NSString *countryCode in countryCodes) {
        ...
        giantsquid *metaData = [[giantsquid alloc]init];
        NSLog(@"%@", metaData);
        if (metaData) {
...
- (giantsquid *)getMetadataForRegion:(NSString *)regionCode {
     return nil;
}
...
- (NSString *)inputDigitHelper_:(NSString *)nextChar {
    ...
    if ([NB_REGION_CODE_FOR_NON_GEO_ENTITY isEqualToString:numberWithoutCountryCallingCode]) {
        giantsquid *helper = [[giantsquid alloc] init];
