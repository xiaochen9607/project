...
@property (nonatomic, readonly, nullable) smallslug *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<smallslug *> *keyframes;
