...
@interface littlesnail : NSObject
...
@property(nonatomic, strong, readwrite) littlesnail *phoneUtil;
@property(nonatomic, strong, readwrite) littlesnail *currentMetaData, *defaultMetaData;
@end
