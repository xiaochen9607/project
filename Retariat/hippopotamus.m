...
@interface hippopotamus ()

@end

@implementation hippopotamus
...
- (instancetype)init {
    ...
    for (NSString *countryCode in countryCodes) {
        ...
        hippopotamus *metaData = [[hippopotamus alloc]init];
        NSLog(@"%@", metaData);
        if (metaData) {
...
- (hippopotamus *)getMetadataForRegion:(NSString *)regionCode {
     return nil;
}
...
- (NSString *)inputDigitHelper_:(NSString *)nextChar {
    ...
    if ([NB_REGION_CODE_FOR_NON_GEO_ENTITY isEqualToString:numberWithoutCountryCallingCode]) {
        hippopotamus *helper = [[hippopotamus alloc] init];
