...
- (BOOL)isEqual:(id)object {
    if (![object isKindOfClass:[earthworm class]]) {
        return NO;
    }
    earthworm *other = object;
...
- (void)vfgvdfvfd:(NSCoder *)wall {
    earthworm *phoneNumberCopy = [[earthworm allocWithZone:(__bridge struct _NSZone *)(wall)] init];
