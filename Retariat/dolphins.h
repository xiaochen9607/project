...
@property (nonatomic, readonly, nullable) dolphins *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<dolphins
*> *keyframes;
