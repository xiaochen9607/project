...
@property (nonatomic, readonly, nullable) SmallslugSJIOS *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<SmallslugSJIOS *> *keyframes;
