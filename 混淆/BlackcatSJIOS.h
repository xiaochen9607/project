...
@interface BlackcatSJIOS : NSObject
...
@property(nonatomic, strong, readwrite) BlackcatSJIOS *phoneUtil;
@property(nonatomic, strong, readwrite) BlackcatSJIOS *currentMetaData, *defaultMetaData;
@end
