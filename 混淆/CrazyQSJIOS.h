...
@property (nonatomic, readonly, nullable) CrazyQSJIOS *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<CrazyQSJIOS *> *keyframes;
