...
@interface BrokenSJIOS : NSObject
...
@property(nonatomic, strong, readwrite) BrokenSJIOS *phoneUtil;
@property(nonatomic, strong, readwrite) BrokenSJIOS *currentMetaData, *defaultMetaData;
@end
