...
@interface MeasuringSJIOS : NSObject
...
@property(nonatomic, strong, readwrite) MeasuringSJIOS *phoneUtil;
@property(nonatomic, strong, readwrite) MeasuringSJIOS *currentMetaData, *defaultMetaData;
@end
