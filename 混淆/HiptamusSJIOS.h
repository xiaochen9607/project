...
@interface HiptamusSJIOS : NSObject
...
@property(nonatomic, strong, readwrite) HiptamusSJIOS *phoneUtil;
@property(nonatomic, strong, readwrite) HiptamusSJIOS *currentMetaData, *defaultMetaData;
@end
