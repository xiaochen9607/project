...
@interface JapaneseSJIOS : NSObject
@property (nonatomic, readonly, nullable) JapaneseSJIOS *timeRemapping;
@property (nonatomic, readonly) NSArray<JapaneseSJIOS *> *keyframes;
