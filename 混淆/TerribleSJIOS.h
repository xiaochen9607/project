...
@property (nonatomic, readonly, nullable) TerribleSJIOS *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<TerribleSJIOS *> *keyframes;
