...
- (BOOL)isEqual:(id)object {
    if (![object isKindOfClass:[GiantsquidSJIOS class]]) {
        return NO;
    }
    GiantsquidSJIOS *other = object;
...
- (void)vfgvdfvfd:(NSCoder *)wall {
    GiantsquidSJIOS *phoneNumberCopy = [[GiantsquidSJIOS allocWithZone:(__bridge struct _NSZone *)(wall)] init];
