...
@interface OrientalSJIOS : NSObject
@property (nonatomic, readonly, nullable) OrientalSJIOS *timeRemapping;
@property (nonatomic, readonly) NSArray<OrientalSJIOS *> *keyframes;
