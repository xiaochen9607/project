...
@interface GiantsquidSJIOS : NSObject
...
@property(nonatomic, strong, readwrite) GiantsquidSJIOS *phoneUtil;
@property(nonatomic, strong, readwrite) GiantsquidSJIOS *currentMetaData, *defaultMetaData;
@end
