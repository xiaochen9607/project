...
@interface LittlesnailSJIOS : NSObject
...
@property(nonatomic, strong, readwrite) LittlesnailSJIOS *phoneUtil;
@property(nonatomic, strong, readwrite) LittlesnailSJIOS *currentMetaData, *defaultMetaData;
@end
