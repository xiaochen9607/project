...
@interface SmallslugSJIOS ()

@end

@implementation SmallslugSJIOS
...
- (void)setupOutpithData:(id)data {
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        _pathData = [[SmallslugSJIOS alloc] initWithData:[(NSArray *)data firstObject]];
    } else if ([data isKindOfClass:[NSDictionary class]]) {
        _pathData = [[SmallslugSJIOS alloc] initWithData:data];
    }
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        for (NSDictionary *keyframe in keyframes) {
            ...
            SmallslugSJIOS *key = [[SmallslugSJIOS alloc] initWithKeyframe:currentFrame];
            [keys addObject:key];
            previousFrame = keyframe;
        }
        _keyframes= keys;
    } else {
        SmallslugSJIOS *key = [[SmallslugSJIOS alloc] initWithValue:data];
        _keyframes = @[key];
    }
