...
@interface CrazyQSJIOS ()

@end

@implementation CrazyQSJIOS
...
- (void)setupOutpithData:(id)data {
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        _pathData = [[CrazyQSJIOS alloc] initWithData:[(NSArray *)data firstObject]];
    } else if ([data isKindOfClass:[NSDictionary class]]) {
        _pathData = [[CrazyQSJIOS alloc] initWithData:data];
    }
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        for (NSDictionary *keyframe in keyframes) {
            ...
            CrazyQSJIOS *key = [[CrazyQSJIOS alloc] initWithKeyframe:currentFrame];
            [keys addObject:key];
            previousFrame = keyframe;
        }
        _keyframes= keys;
    } else {
        CrazyQSJIOS *key = [[CrazyQSJIOS alloc] initWithValue:data];
        _keyframes = @[key];
    }
