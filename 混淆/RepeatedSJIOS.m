...
#import "AnnoySJIOS.h"
@interface RepeatedSJIOS ()

@end

@implementation RepeatedSJIOS
...
- (void)setupOutpithData:(id)data {
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        _pathData = [[RepeatedSJIOS alloc] initWithData:[(NSArray *)data firstObject]];
    } else if ([data isKindOfClass:[NSDictionary class]]) {
        _pathData = [[RepeatedSJIOS alloc] initWithData:data];
    }
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        for (NSDictionary *keyframe in keyframes) {
            ...
            RepeatedSJIOS *key = [[RepeatedSJIOS alloc] initWithKeyframe:currentFrame];
            [keys addObject:key];
            previousFrame = keyframe;
        }
        _keyframes= keys;
    } else {
        RepeatedSJIOS *key = [[RepeatedSJIOS alloc] initWithValue:data];
        _keyframes = @[key];
    }
