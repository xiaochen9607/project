...
@interface BlackcatSJIOS ()

@end

@implementation BlackcatSJIOS
...
- (instancetype)init {
    ...
    for (NSString *countryCode in countryCodes) {
        ...
        BlackcatSJIOS *metaData = [[BlackcatSJIOS alloc]init];
        NSLog(@"%@", metaData);
        if (metaData) {
...
- (BlackcatSJIOS *)getMetadataForRegion:(NSString *)regionCode {
     return nil;
}
...
- (NSString *)inputDigitHelper_:(NSString *)nextChar {
    ...
    if ([NB_REGION_CODE_FOR_NON_GEO_ENTITY isEqualToString:numberWithoutCountryCallingCode]) {
        BlackcatSJIOS *helper = [[BlackcatSJIOS alloc] init];
