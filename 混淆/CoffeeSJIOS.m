...
#import "TrainSJIOS.h"
@interface CoffeeSJIOS ()

@end

@implementation CoffeeSJIOS
...
- (void)setupOutpithData:(id)data {
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        _pathData = [[CoffeeSJIOS alloc] initWithData:[(NSArray *)data firstObject]];
    } else if ([data isKindOfClass:[NSDictionary class]]) {
        _pathData = [[CoffeeSJIOS alloc] initWithData:data];
    }
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        for (NSDictionary *keyframe in keyframes) {
            ...
            CoffeeSJIOS *key = [[CoffeeSJIOS alloc] initWithKeyframe:currentFrame];
            [keys addObject:key];
            previousFrame = keyframe;
        }
        _keyframes= keys;
    } else {
        CoffeeSJIOS *key = [[CoffeeSJIOS alloc] initWithValue:data];
        _keyframes = @[key];
    }
