...
@interface ElephantSJIOS : NSObject
@property (nonatomic, readonly, nullable) ElephantSJIOS *timeRemapping;
@property (nonatomic, readonly) NSArray<ElephantSJIOS *> *keyframes;
