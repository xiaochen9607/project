...
@interface EarthwormSJIOS ()

@end

@implementation EarthwormSJIOS
...
- (instancetype)init {
    ...
    for (NSString *countryCode in countryCodes) {
        ...
        EarthwormSJIOS *metaData = [[EarthwormSJIOS alloc]init];
        NSLog(@"%@", metaData);
        if (metaData) {
...
- (EarthwormSJIOS *)getMetadataForRegion:(NSString *)regionCode {
     return nil;
}
...
- (NSString *)inputDigitHelper_:(NSString *)nextChar {
    ...
    if ([NB_REGION_CODE_FOR_NON_GEO_ENTITY isEqualToString:numberWithoutCountryCallingCode]) {
        EarthwormSJIOS *helper = [[EarthwormSJIOS alloc] init];
