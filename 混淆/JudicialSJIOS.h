...
@interface JudicialSJIOS : NSObject
@property (nonatomic, readonly, nullable) JudicialSJIOS *timeRemapping;
@property (nonatomic, readonly) NSArray<JudicialSJIOS *> *keyframes;
...
@property(nonatomic, assign) BOOL nationalmatting;
@property(nonatomic, strong) NSString *domesticRule;
