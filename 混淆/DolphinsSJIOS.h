...
@property (nonatomic, readonly, nullable) DolphinsSJIOS *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<DolphinsSJIOS
*> *keyframes;
