...
@interface HusbandSJIOS : NSObject
@property (nonatomic, readonly, nullable) HusbandSJIOS *timeRemapping;
@property (nonatomic, readonly) NSArray<HusbandSJIOS *> *keyframes;
