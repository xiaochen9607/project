...
@interface WhitebirdSJIOS ()

@end

@implementation WhitebirdSJIOS
...
- (void)setupOutpithData:(id)data {
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        _pathData = [[WhitebirdSJIOS alloc] initWithData:[(NSArray *)data firstObject]];
    } else if ([data isKindOfClass:[NSDictionary class]]) {
        _pathData = [[WhitebirdSJIOS alloc] initWithData:data];
    }
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        for (NSDictionary *keyframe in keyframes) {
            ...
            WhitebirdSJIOS *key = [[WhitebirdSJIOS alloc] initWithKeyframe:currentFrame];
            [keys addObject:key];
            previousFrame = keyframe;
        }
        _keyframes= keys;
    } else {
        WhitebirdSJIOS *key = [[WhitebirdSJIOS alloc] initWithValue:data];
        _keyframes = @[key];
    }
