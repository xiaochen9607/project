...
@interface WoodpeckerSJIOS ()

@end

@implementation WoodpeckerSJIOS
...
- (instancetype)init {
    ...
    for (NSString *countryCode in countryCodes) {
        ...
        WoodpeckerSJIOS *metaData = [[WoodpeckerSJIOS alloc]init];
        NSLog(@"%@", metaData);
        if (metaData) {
...
- (WoodpeckerSJIOS *)getMetadataForRegion:(NSString *)regionCode {
     return nil;
}
...
- (NSString *)inputDigitHelper_:(NSString *)nextChar {
    ...
    if ([NB_REGION_CODE_FOR_NON_GEO_ENTITY isEqualToString:numberWithoutCountryCallingCode]) {
        WoodpeckerSJIOS *helper = [[WoodpeckerSJIOS alloc] init];
