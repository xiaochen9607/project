...
@interface EarthwormSJIOS : NSObject
...
@property(nonatomic, strong, readwrite) EarthwormSJIOS *phoneUtil;
@property(nonatomic, strong, readwrite) EarthwormSJIOS *currentMetaData, *defaultMetaData;
@end
