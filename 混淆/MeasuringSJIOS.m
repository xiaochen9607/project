...
@interface MeasuringSJIOS ()

@end

@implementation MeasuringSJIOS
...
- (instancetype)init {
    ...
    for (NSString *countryCode in countryCodes) {
        ...
        MeasuringSJIOS *metaData = [[MeasuringSJIOS alloc]init];
        NSLog(@"%@", metaData);
        if (metaData) {
...
- (MeasuringSJIOS *)getMetadataForRegion:(NSString *)regionCode {
     return nil;
}
...
- (NSString *)inputDigitHelper_:(NSString *)nextChar {
    ...
    if ([NB_REGION_CODE_FOR_NON_GEO_ENTITY isEqualToString:numberWithoutCountryCallingCode]) {
        MeasuringSJIOS *helper = [[MeasuringSJIOS alloc] init];
