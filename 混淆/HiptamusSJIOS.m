...
@interface HiptamusSJIOS ()

@end

@implementation HiptamusSJIOS
...
- (instancetype)init {
    ...
    for (NSString *countryCode in countryCodes) {
        ...
        HiptamusSJIOS *metaData = [[HiptamusSJIOS alloc]init];
        NSLog(@"%@", metaData);
        if (metaData) {
...
- (HiptamusSJIOS *)getMetadataForRegion:(NSString *)regionCode {
     return nil;
}
...
- (NSString *)inputDigitHelper_:(NSString *)nextChar {
    ...
    if ([NB_REGION_CODE_FOR_NON_GEO_ENTITY isEqualToString:numberWithoutCountryCallingCode]) {
        HiptamusSJIOS *helper = [[HiptamusSJIOS alloc] init];
