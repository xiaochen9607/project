...
public:
	...
	bool init(const std::string &mainPath);
...
class ClightningBoltNode:public cocos2d::Node
{
public:
    ClightningBoltNode(){
        m_lbSprite=NULL;
    ...
    bool init(const CCPoint&start,const CCPoint&end,const std::string &mainPath);
    ...
    void runFlashAction(float flashTime);
	static ClightningBoltNode *create();
protected:
